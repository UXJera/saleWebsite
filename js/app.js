...
myApp.controller('ItemController',['$scope', function($scope) {
	...
	},
	{
		...
		image: 'img/dice1.jpg',
		price: 99.99,
		description: '<li><span>Table Dimensions:</span> 42" x 42" x 30" </li><li><span>Chair Dimensions:</span> Chair Dimensions here</li>',
		soldOut: false,
	},
	{
		...
		image: 'img/dice1.jpg',
		price: 9.99,
		description: '<li><span>Slot Machine Dimensions:</span> 32" x 20" x 15" </li>',
		soldOut: false,
	},
	{
		name: "Two Nightstand and Armoire",
		type: "furniture",
		thumb: 'img/dice.jpg',
		image: 'img/dice1.jpg',
		price: 149.99,
	...
	},	
	{
		...
		image: 'img/dice1.jpg',
		price: 49.99,
		description: '<li><span>TV Stand Dimensions:</span> 42" x 26" x 20" </li><li>Two side cabinets, two shelves in center</li>',
		soldOut: false,
	},		
	{
		...
		image: 'img/dice1.jpg',
		price: 39.99,
		description: '<li><span>Dresser Dimensions:</span> 46" x 46" x 20" </li><li>!!! Look for description !!!</li>',
		soldOut: false,
	},
	{
		...
		image: 'img/dice1.jpg',
		price: 999.99,
		description: '<li><span>Table Dimensions:</span> 68" x 44" and Three 12" leaves</li><li>Crank handle to put side leafs in or out.</li><li>6 Ornate chairs with cane seats included.</li>',
		soldOut: false,
	},
	{
		...
		image: 'img/dice1.jpg',
		price: 349.99,
		description: '<li><span>Buffet Dimensions:</span> 65" x 42"</li><li>Two upper drawers, two center drawers, two side cabinets.</li>',
		soldOut: false,
	},
	{
		name: "Dark Oak Table",
		...
		image: 'img/dice1.jpg',
		price: 149.99,
		description: '<li><span>Table Dimensions:</span> 24" x 28" x 18" with two 12" sides</li><li>Two folding sides, one drawer in front</li>',
		soldOut: false,
	},
	{
		...
		image: 'img/dice1.jpg',
		price: 299.99,
		description: '<li><span>Mirror Dimensions:</span> 24" x 28" x 18" with two 12" sides</li>',
		soldOut: false,
	},
	{
		...
		image: 'img/dice1.jpg',
		price: 399.99,
		description: '<li><span>Bench Dimensions:</span> 48" x 54" x 24"</li><li>Cream background with flowers, matches fainting couch.</li>',
		soldOut: false,
	},
	{
		name: "Fainting Couch",
		...
		image: 'img/dice1.jpg',
		price: 499.99,
		description: '<span>Couch Dimensions</span> 52" x 86" x 26"</li><li>Cream background with flowers, matches preacher bench.</li>',
		soldOut: false,
	},
	{
		...
		image: 'img/dice1.jpg',
		price: 199.99,
		description: '<span>Chair Dimensions</span> 52" x 86" x 26"</li><li>Salmon color with stripes and flower pattern.</li><li>Ball and clawfeet</li>',
		soldOut: false,
	},
	{
		name: "Table Set",
	...
	},
	{
		...
		image: 'img/dice1.jpg',
		price: 99.99,
		description: '<li><span>Cabinet Dimensions:</span> 12" x 18" x 36" </li><li>Comes with 1000 tokens, machine key. Fully functional.</li>',
		soldOut: false,
	}
	];
}]);
